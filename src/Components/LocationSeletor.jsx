...
const LocationSeletor = ({ type, border = "1px solid", borderColor = "gray.200", color = "gray.900" }) => {
      ...
      <Menu borderRadius={0}>
        {type === "search" ? (
          <MenuButton
            ...
            variant={"ghost"}
            color={color}
            _hover={{ bg: "none", borderColor: borderColor }}
            _active={{ bg: "none" }}
            ...
            borderRight={{ base: border, md: "none" }}
            borderRightColor={{ base: borderColor, md: "none" }}
